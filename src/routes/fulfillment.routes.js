...
router.post('/sales-orders/:salesOrderId/picks', authorize(ROLES.ADMIN, ROLES.WAREHOUSE), createPickHandler);
router.post('/sales-orders/:salesOrderId/picks/:pickId/confirm', authorize(ROLES.ADMIN, ROLES.WAREHOUSE), confirmPickHandler);
