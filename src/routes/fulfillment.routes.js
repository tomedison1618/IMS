...
import { confirmPickHandler, createPickHandler, getOpenPickHandler } from '../controllers/fulfillment.controller.js';
...
router.get('/sales-orders/:salesOrderId/picks/open', authorize(ROLES.ADMIN, ROLES.OPERATIONS), getOpenPickHandler);
